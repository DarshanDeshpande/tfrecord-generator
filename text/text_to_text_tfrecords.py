...
class Converter:
    ...
    def write_tfrecord(self, num_files, path_in, path_out, out_dir, num_lines_per_file=None, *args):
        '''
        num_files: int, Number of TFRecord files to be created
        ...
        lines_in_each_file = num_lines_per_file / num_files
...
if __name__ == '__main__':
    ...
    converter = Converter()
    converter.write_tfrecord(arguments.nfiles, arguments.path_in, arguments.path_out, arguments.out_dir,
